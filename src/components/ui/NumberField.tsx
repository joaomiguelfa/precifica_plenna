...
export function NumberField({
  ...
  return (
    <label className={`block text-sm ${className}`}>
      ...
      <div className="flex items-stretch overflow-hidden rounded-md border border-slate-300 focus-within:border-indigo-500 focus-within:ring-1 focus-within:ring-indigo-500 dark:border-slate-700">
        <input
          type="number"
          inputMode="decimal"
          className="w-full min-w-0 flex-1 bg-white px-3 py-2 text-slate-900 outline-none dark:bg-slate-900 dark:text-slate-100"
